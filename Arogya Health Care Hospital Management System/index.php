...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      <!-- Add the hospital logo to navigation br -->
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4> <img src="images/favicon1.png"/></h4></a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <!-- Add buttons for navigation bar -->
...
<!-- Create a login form for web application -->
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
    <div class="row">
        ...
        <!-- Add three user options for login form -->
         <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
            ...
            <!-- Create tabs for add information -->
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <h3 class="register-heading">Register as Patient</h3>
                    <form method="post" action="func2.php">
                <div class="row register-form">
            <!-- Create left side of the form -->
            <div class="col-md-6">
                ...
                <!-- Add radio button for select male of female -->
                <div class="form-group">
                    <div class="maxl">
            ...
            <!-- Create a form for loging to doctors -->
            ...
            <!-- Create a form for loging as admin -->
            <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="row register-form">
                    <div class="col-md-6">
                        <div class="form-group">
                            <!-- Add user name of admin -->
                            <input type="text" class="form-control" placeholder="User Name *" name="username1" onkeydown="return alphaOnly(event);" required/>
                        </div>
                    </div>
                <div class="col-md-6">
            <div class="form-group">
            <!-- Add password of admin -->
