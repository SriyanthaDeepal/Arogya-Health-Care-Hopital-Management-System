<!-- Connect Databae for unregistered patient -->
<?php
session_start();
$con=mysqli_connect("localhost","root","","myhmsdb");
// Check whether all the fields of patient registration form is filled.
if(isset($_POST['patsub1'])){
  ...
  //If password and confirm password mathcing then store data of new patient
  if($password==$cpassword){
    ...
    //When patient loging to form all data are loading.
  ...
  //If user logging condition are not fullfilled, a message show
  else{
    header("Location:error1.php");
  }
}

//If user create a new appointment database will updated
...
// When patient select a doctor, data of doctors will load to fields
...
//Create a page for patient functanalities
