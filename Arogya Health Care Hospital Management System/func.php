<!-- Connect Database for registered pateint functanalities -->
<?php
session_start();
// Connect with database
$con=mysqli_connect("localhost","root","","myhmsdb");
//Check inserted email and password are corrected or not
if(isset($_POST['patsub'])){
	$email=$_POST['email'];
	$password=$_POST['password2'];
  // Select all data for given verified email id
	$query="select * from patreg where email='$email' and password='$password';";
	$result=mysqli_query($con,$query);
	if(mysqli_num_rows($result)==1)
	{
    //Load database data into created variables
    ...
    //If email and password is correct, patient admit to the application
		header("Location:admin-panel.php");
	}
  // If email or password is incorrect show a message
  else {
...
<html lang="en">
  ...
  <!-- Create Navigation bar of the page -->
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
       <!-- Add logout button for the page -->
 ...
 <div class="jumbotron" id="ab1"></div>
   <div class="container-fluid" style="margin-top:50px;">
    <div class="row">
  <div class="col-md-4">
    <!-- Create a table of functionalities -->
